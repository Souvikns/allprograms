...
const long calculatorDialog::ID_STATICTEXT1 = wxNewId();
const long calculatorDialog::ID_BUTTON1 = wxNewId();
const long calculatorDialog::ID_STATICLINE1 = wxNewId();
const long calculatorDialog::ID_BUTTON2 = wxNewId();
//*)
...
calculatorDialog::calculatorDialog(wxWindow* parent,wxWindowID id)
{
    ...
    Connect(ID_BUTTON1,wxEVT_COMMAND_BUTTON_CLICKED,(wxObjectEventFunction)&calculatorDialog::OnAbout);
    Connect(ID_BUTTON2,wxEVT_COMMAND_BUTTON_CLICKED,(wxObjectEventFunction)&calculatorDialog::OnQuit);
    //*)
}
