...
//(*IdInit(calDialog)
const long calDialog::ID_STATICTEXT1 = wxNewId();
const long calDialog::ID_BUTTON1 = wxNewId();
const long calDialog::ID_STATICLINE1 = wxNewId();
const long calDialog::ID_BUTTON2 = wxNewId();
//*)

BEGIN_EVENT_TABLE(calDialog,wxDialog)
    //(*EventTable(calDialog)
    //*)
END_EVENT_TABLE()

calDialog::calDialog(wxWindow* parent,wxWindowID id)
{
    //(*Initialize(calDialog)
    ...
    Connect(ID_BUTTON1,wxEVT_COMMAND_BUTTON_CLICKED,(wxObjectEventFunction)&calDialog::OnAbout);
    Connect(ID_BUTTON2,wxEVT_COMMAND_BUTTON_CLICKED,(wxObjectEventFunction)&calDialog::OnQuit);
    //*)
}
...
void calDialog::OnQuit(wxCommandEvent& event)
{
    Close();
}

void calDialog::OnAbout(wxCommandEvent& event)
{
